...
Version 25.0 (11.09.2019) 2 & 3 channel versions

- Improved noise generator and mixer.
...
Example:
	avrdude -p m8 -c USBasp -U flash:w:AY_Emul_250_2ch_m8_ay.hex -U eeprom:w:Conf_standard_27MHz_1_75Mhz.hex -U lfuse:w:0xCE:m -U hfuse:w:0xCF:m
=============================================================
...
Example:
	avrdude -p m48 -c USBasp -U flash:w:AY_Emul_250_2ch_m48_ay.hex -U eeprom:w:Conf_standard_27MHz_1_75Mhz.hex -U lfuse:w:0xee:m -U hfuse:w:0xdd:m -U efuse:w:0xff:m
=============================================================
...
Example:
	avrdude -p m168 -c USBasp -U flash:w:AY_Emul_250_2ch_m168_ay.hex -U eeprom:w:Conf_standard_27MHz_1_75Mhz.hex -U lfuse:w:0xee:m -U hfuse:w:0xdd:m -U efuse:w:0xff:m
=============================================================
