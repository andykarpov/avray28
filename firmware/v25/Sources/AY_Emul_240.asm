; AY-3-8912 IC emulator version 24.0 for ATMega8 18.02.2016
;
...
#define Envelope_Max_Volume 60		; should be as the last value in VolTab2
; volume table for envelopes
VolTab2:
	.db 0,1,1,2,3,4,5,7,9,9,10,12,12,13,14,16,16,18,20,20,21,22,25,25,27,29,32,36,40,46,52,Envelope_Max_Volume
...
ENVELOPE_GENERATOR_END:
	...
	brcs	NOISE_LOW
	ori	TNLevel,0x38	; set noise HIGH if carry is not set
	sbrc RNGH,b6		; if bit 14 of RNG is clear - skip next line
	or NoiseAddon,ZH	; set random number generator additional bit
	rjmp NOISE_GENERATOR_END
NOISE_LOW:
	sbrs	RNGH,b6		; if bit 14 of RNG is set - skip next line
	or	NoiseAddon,ZH	; set random number generator additional bit
NOISE_GENERATOR_END:
	/////////////////////////////////////////////////////////////////////////////////////
