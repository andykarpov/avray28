; AY-3-8912 I	C emulator version 22.0 for ATMega8 01.02.2016
;
...
// Alternate version only part ----------
	; swap bits 5 and 6
	mov	BusOut2,BusData
	subi	BusOut2,0xE0	; +0x20
	sbrc	BusOut2,b6		; check if bits 5 and 6 is differ, skip next if not
	eor	BusData,C60
// --------------------------------------
#endif	
