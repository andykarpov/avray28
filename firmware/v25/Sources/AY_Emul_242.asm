; AY-3-8912 IC emulator version 24.2 for ATMega8 25.08.2016
;
...
ENVELOPE_GENERATOR_END:
	...
	brcc	NO_LEVEL_CHANGED	; brach if CARRY = 0
	ori	TNLevel,0x38	; set noise HIGH if carry is set
NO_LEVEL_CHANGED:
	mov YL,RNGL		; xor bits 0 and 2
	lsr YL
	eor TMP,YL
	lsr TMP
	rol NoiseAddon	; move result to 16 bit of RNG
