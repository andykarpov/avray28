; AY-3-8912 IC emulator version 24.5 for ATMega8/48/88/168/328 14.02.2017
;
...
LATCH_REG_ADDR:
	...
	in	ADDR,PinC		; receive register number	// 1 cycle
...
ENVELOPE_GENERATOR_END:
	...
	/// NOISE GENERATOR
	/////////////////////////////////////////////////////////////////////////////////////
	dec	CntN		; increase noise period counter
...
NNN:
	andi	TNLevel,0xC7	; clear noise bits
	lsr	NoiseAddon
	mov	NoiseAddon,RNGL
	ror	RNGH
	ror	RNGL
